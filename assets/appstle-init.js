      ...
      <span  class="appstle_lowercase appstle_sellingPlan_price appstle_onetime_amount">{{{oneTimePuchaseAmount}}}</span>
        ...
        {{#sellingPlanVariants}}
           <div class="appstle_input_wrapper appstle_subscription_option">
             <input type="radio" class="appstleSellingPlan{{widgetId}}" id="{{sellingPlanId}}" value="{{sellingPlanId}}" name="selling_plan" {{#subscriptionOptionSelectedDefault}}checked{{/subscriptionOptionSelectedDefault}} />
             {{^prepaidFlag}}
